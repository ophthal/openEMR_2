...
$ref_data =  sqlQuery($query, array($pat_data['referrerID']));
...
<div id="page-wrapper" data-role="page">
    ...
    <div id="Layer3" name="Layer3" class="container-fluid">
        ...
        <!-- start form -->
        <form method="post" action="<?php echo $rootdir;?>/forms/<?php echo $form_folder; ?>/save.php?mode=update" id="eye_mag" class="eye_mag pure-form row" name="eye_mag">
        ...
        menu_overhaul_left($pid, $encounter);
                    ...
                    <!-- start first div -->
                    <div id="first" name="first" class="text_clinical row">
                        <!-- start    HPI spinner -->
                        ...
                        <div id="HPIPMH_sections" class="nodisplay">
                            ...
                            <div id="HPI_1" name="HPI_1" class="<?php echo attr($display_Add); ?>">
                                ...
                                <!-- start  HPI Left -->
                                <div id="HPI_left" name="HPI_left" class="exam_section_left borderShadow col-6">
                                ...
                                <!-- start  HPI Right -->
                                <div id="HPI_right" name="HPI_right" class="exam_section_right borderShadow col-6">
                            ...
                            <div id="PMH_1" name="PMH_1" class="<?php echo attr($display_Add); ?> clear_both">
                                ...
                                <!-- start  PMH Left -->
                                <div id="PMH_left" name="PMH_left" class="exam_section_left borderShadow col-6">
                                ...
                                <!-- end    PMH Left -->
                                <!-- start  PMH Right -->
                                <div id="PMH_right" name="PMH_right" class="exam_section_right borderShadow col-6">
                    ...
                    <div class="clear_both row" id="LayerTechnical_sections_1" name="LayerTechnical_sections" >
                        ...
                        <div id="LayerVision" class="vitals col-12">
                    ...
                    <div id="LayerVision_IOP" class="borderShadow <?php echo $display_IOP; ?> col-12">
                    ...
                    <div id="REFRACTION_sections" name="REFRACTION_sections" class="row nodisplay clear_both">
                        <div id="LayerVision2" class="col-12">
                    ...
                    <div class="sections bold" name="mid_menu col-12" id="mid_menu">
                        <span id="EXAM_defaults" name="EXAM_defaults" value="Defaults" class="btn btn-primary">
                            <i class="fa fa-newspaper-o"></i> <?php echo xlt('Defaults'); ?></span>
                        <span id="EXAM_TEXT" name="EXAM_TEXT" value="TEXT" class="btn btn-primary">
                            <i class="fa fa-hospital-o"></i> <?php echo xlt('Text'); ?></span>
                        <span id="EXAM_DRAW" name="EXAM_DRAW" value="DRAW" class="btn btn-primary">
                            <i class="fa fa-paint-brush fa-sm"> </i> <?php echo xlt('Draw'); ?></span>
                        <span id="EXAM_QP" name="EXAM_QP" title="<?php echo xla('Open the Quick Pick panels'); ?>" value="QP" class="btn btn-primary">
                            <i class="fa fa-database fa-sm"> </i> <?php echo xlt('Quick Picks'); ?>
                        </span>
                        <?php
                        ...
                        <span id="PRIORS_ALL_left_text" name="PRIORS_ALL_left_text"
                              class="btn btn-primary"><i class="fa fa-paste" title="<?php echo xla($title); ?>"></i>
                            <?php
                                if ($output_priors !='') {
                                    echo $output_priors;
                                } else {
                    ...
                    <div class="nodisplay" id="DA_EXAM_sections" name="DA_EXAM_sections">
                        ...
                        <div id="EXT_1" name="EXT_1" class="clear_both">
                            ...
                            <div id="EXT_left" class="col-6 exam_section_left borderShadow" >
                            ...
                            <div id="EXT_right" name="EXT_right" class="col-6 exam_section_right borderShadow text_clinical">
                        ...
                        <div id="ANTSEG_1" class="clear_both">
                            <div id="ANTSEG_left" name="ANTSEG_left" class="col-6 exam_section_left borderShadow">
                            ...
                            <div id="ANTSEG_right" name=="ANTSEG_right" class="col- exam_section_right borderShadow text_clinical ">
                        ...
                        <div id="POSTSEG_1" class="clear_both" >
                            <div id="RETINA_left" name="RETINA_left" class="col-6 exam_section_left borderShadow">
                            ...
                            <div id="RETINA_right" name="RETINA_right"class="col-6 exam_section_right borderShadow text_clinical">
                        ...
                        <br />
                        <!-- start IMP/PLAN -->
                        <div class="size50 clear_both col-" id="IMPPLAN_1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding-left:15px;vertical-align:text-top;text-left">
                                                                <div class="widget text-center">
                                                                    ...
                                                                    <button id="code_me_now" style="background-color: #eecece;"><?php echo xlt('Populate Fee Sheet'); ?></button>
                                                                    <button id="open_fee_sheet" style="background-color: #eecece;"
                                                ...
                                                <div style="padding:5px 20px 5px 20px;">
                                                    ...
                                                    <table style="width:100%;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php
                                                                    if ($pcp_data['phonew2']) {
                                                                        echo "<br /><span id=\"pcp_phonew2\">". text($pcp_data['phonew2'])."</span>";
                                                                }
                                                                ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if ($ref_data['phonew2']) {
                                                                        echo "<br /><span id=\"ref_phonew2\">". text($ref_data['phonew2'])."</span>";
                                                                } ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <?php
                                                        if ($pcp_data['fax'] > '') {
                                                            ...
                                                            if ($FAX_PCP['ID']) { //it is here already, make them print and manually fax it.  Show icon
                                                                if (!empty($FAX_PCP['COMPLETED_DATE'])) {
                                                                ...
                                                                <span id='status_Fax_pcp'>
                                                                    ...
                                                                    target='_blank' title='".xla('View the Summary Report sent via Fax Server on')." ".$sent_date.".'>
                                                                    <i class='fa fa-file-pdf-o fa-fw'></i></a>
                                                                    <i class='fa fa-repeat fa-fw'
                                                                       title=\"".xla('Resend this Report.
                                                                            Changes to this record will be included in this new Fax.')."\"
                                                                       onclick=\"top.restoreSession(); create_task('".attr($pat_data['providerID'])."','Fax-resend','ref'); return false;\"></i>
                                                                </span>";
                                                            } else { ?>
                                                                <a href="#" onclick="top.restoreSession(); create_task('<?php echo attr($pat_data['providerID']); ?>','Fax','pcp'); return false;">
                                                                    <?php echo text($pcp_data['fax']); ?>&nbsp;&nbsp;<span id="status_Fax_pcp"><i class="fa fa-fax fa-fw"></i>  Send Fax</span></a>
                                                                <?php
                                                            }
                                                        } ?>
                                                  </span>
                                                  ...
                                                  <span id="ref_fax">
                                                    <?php if ($ref_data['fax'] > '') {
                                                        // does the fax already exist?
                                                        $query    = "SELECT * FROM form_taskman WHERE TO_ID=? and PATIENT_ID=? and ENC_ID=?";
                                                        $FAX_REF  =  sqlQuery($query, array($pat_data['referrerID'],$pid,$encounter));
                                                        if ($FAX_REF['ID']) { //it is here already, show icon.
                                                            if (!empty($FAX_REF['COMPLETED_DATE'])) {
                                                                $dated = new DateTime($task['COMPLETED_DATE']);
                                                                $dated = $dated->format('Y-m-d');
                                                                $sent_date = oeFormatShortDate($dated);
                                                            }
                                                            echo text($ref_data['fax'])."&nbsp;&nbsp;
                                                              <span id='status_Fax_ref'>
                                                                  ...
                                                                  <i class='fa fa-repeat fa-fw'
                                                                    title=\"".xla('Resend this Report.
                                                                            Changes to this record will be included in this new Fax.')."\"
                                                                    onclick=\"top.restoreSession(); create_task('".attr($pat_data['referrerID'])."','Fax-resend','ref'); return false;\"></i>
                                                              </span>";
                                                        } else { ?>
                                                                <a href="#" onclick="top.restoreSession(); create_task('<?php echo attr($pat_data['referrerID']); ?>','Fax','ref'); return false;">
                                                                    <?php echo text($ref_data['fax']); ?>&nbsp;&nbsp;
                                                                <span id="status_Fax_ref"><i class="fa fa-fax fa-fw"></i>  Send Fax</span></a>
                                                            <?php
                                                        }
                                                    } ?>
                                                  </span>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr><td class="top bold"><?php echo xlt('Pharmacy'); ?>:</td>
                                                            <?php
                                                                ...
                                                                echo "<td  colspan='2' style='max-width:275px;'>";
                                                                ob_start();
                                                                generate_form_field($frow, $pat_data['pharmacy_id']);
                                                                $select_pharm = ob_get_clean();
                                                                echo str_replace("form-control", "pharma", $select_pharm);
                                                            ?>
                                                            </td><td class="top">
                                                                <button style="background-color: #eecece;" onclick="editScripts('/openemr/controller.php?prescription&list&id=<?php echo attr($pat_data['pid']); ?>');"><?php echo xlt('eRx'); ?></button>
                                                            </td></tr>
